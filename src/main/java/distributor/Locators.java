...
*/	
	...
	{
		user = getDriver().findElement(By.xpath("(//input[@type='checkbox'])[6]"));
		return user;
	}
	...
	public static WebElement  OnboardEntityEdit ( )		
	{
		user = getDriver().findElement(By.xpath("//img[@title='Edit']"));
		return user;
	}
	public static WebElement  OnboardEntityAddressMapping ( )		
	{
		user = getDriver().findElement(By.xpath("//img[@title='Addressmapping']"));
		return user;
	}
	public static WebElement  OnboardEntityAddressMapping_SaveButton ( )		
	{
	...
	{
		user = getDriver().findElement(By.xpath("(//span[@class='k-input-value-text'])[2]"));
		return user;
	}
	
	public static WebElement  OfficeType1( )		
	{
		user = getDriver().findElement(By.xpath("//span[normalize-space()='Branch']"));
		return user;
	}
	...
	{
		user = getDriver().findElement(By.xpath("//input[@placeholder='RC No']"));
		return user;
	}
	
	public static WebElement  RCValidFromCalendar( )		
	{
		user = getDriver().findElement(By.xpath("//kendo-svgicon[@class='k-svg-i-calendar k-button-icon k-svg-icon k-icon']"));
		return user;
	}
	public static WebElement  RCValidToCalendar( )		
	{
		user = getDriver().findElement(By.xpath("(//kendo-svgicon[@class='k-svg-i-calendar k-button-icon k-svg-icon k-icon'])[2]"));
		return user;
	}
	...
	{
		user = getDriver().findElement(By.xpath("(//span[@class='k-input-value-text'])[7]"));
		return user;
	}
	...
	{
		user = getDriver().findElement(By.xpath("(//*[@class='k-svg-i-calendar k-button-icon k-svg-icon k-icon'])[4]"));
		return user;
	}
	
	public static WebElement  StatusB( )		
	{
		user = getDriver().findElement(By.xpath("(//span[@class='k-input-value-text'])[10]"));
		return user;
	}
	...
	public static WebElement  PaycodeSearch( )		
	{
		user = getDriver().findElement(By.xpath("//input[@class='k-input-inner']"));
		return user;
	}
	...
	public static WebElement  PaycodTypeField( )		
	{
		user = getDriver().findElement(By.xpath("//input[@name='paycodeType']"));
		return user;
	}
	public static WebElement  PaycodeHeaderNameField( )		
	{
		user = getDriver().findElement(By.xpath("//input[@name='headerName']"));
		return user;
	}
	public static WebElement  PaycodeDisabledField( )		
	{
		user = getDriver().findElement(By.xpath("//input[@name='paycode']"));
		return user;
	}
	...
	public static WebElement  PaycodMasterSampleFileDownload( )		
	{
		user = getDriver().findElement(By.xpath("(//a[normalize-space()='Master Paycode'])[1]"));
		return user;
	}
	public static WebElement MessageTextF4()	 
	{
		user = getDriver().findElement(By.xpath("//h4[@class='f-label']"));
		return user;
	}
	public static WebElement  PaycodUploadPaycodeDownload( )		
	{
		user = getDriver().findElement(By.xpath("(//a[normalize-space()='Upload Paycode'])[1]"));
		return user;
	}
	...
	public static WebElement   SearchUserm2 ( )		//Select first value 
	{
		user = getDriver().findElement(By.xpath("//span[@class='k-list-item-text ng-star-inserted']"));
		return user;
	}
