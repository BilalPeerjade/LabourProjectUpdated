...
public class EPF_ConsolatedTestCases extends BasePage {
	...
	public static String link = "mgmt1";
		...
		{
			test = extent.startTest("PF Consolidated - Validate Data in 'Gross Wages' Column");
			
			EPF_ConsolatedMethods.PfCO_Remittance_M_GrossWage_Total(test,"Performer");
		...
		@Test(priority = 2) 
		void StaturyDocPF_Basic_EPFwagesMatching2() throws InterruptedException, IOException, AWTException
		{			
			
			test = extent.startTest("PF Consolidated - Validate Data in 'Basic Wages' Column");
			EPF_ConsolatedMethods.PfCO_Remittance_N_BasicWages_Total(test, link);
		...
		@Test(priority = 2) 
		void PfCO_Remittance_EmployeeCheck() throws InterruptedException, IOException, AWTException
		{			
			
			test = extent.startTest("PF Consolidated - Validate Data in 'Basic Wages' Column");
			EPF_ConsolatedMethods.PfCO_Remittance_EmployeeCheck(test, link);
			
			test = extent.startTest("PF Consolidated - Validate Employee Names");
			EPF_ConsolatedMethods.PfCO_Remittance_EmployeeCheck2(test, link);
