...
public class PT extends BasePage {
...
//		@Test(priority = 2) 
//		void Challan_PT_EmployeeName() throws InterruptedException, IOException, AWTException
//		{
//			test = extent.startTest("");
//			
//			PT_Methods.Challan_PT_EmployeeName(test,"Performer");
//			
//			extent.endTest(test);
//			extent.flush();
//		}
		...
		@Test(priority = 2) 
		void Challan_PT_EmployeeNamee() throws InterruptedException, IOException, AWTException
		{
			test = extent.startTest("PT Challan - Validate 'Employee Names' are reflecting correctly");
			
			PT_Methods.Challan_PT_EmployeeNamee(test,"Performer");
		...
		@Test(priority = 3) 
		void Challan_PT_Gender() throws InterruptedException, IOException, AWTException
		{
			test = extent.startTest("PT Challan - Validate 'Genders' are reflecting correctly");
			
			PT_Methods.Challan_PT_Gender(test,"Performer");
		...
		@Test(priority = 4) 
		void Challan_PT_Locations() throws InterruptedException, IOException, AWTException
		{
			test = extent.startTest("PT Challan - Validate 'Locations' are reflecting correctly");
			
			PT_Methods.Challan_PT_Locations(test,"Performer");
		...
		@Test(priority = 5) 
		void Challan_PT_PTGrossWages() throws InterruptedException, IOException, AWTException
		{
			test = extent.startTest("PT Challan - Validate 'PT Gross wages' are reflecting correctly");
			
			PT_Methods.Challan_PT_PTGrossWages(test,"Performer");
			
			extent.endTest(test);
			extent.flush();
		}
		
		@Test(priority = 6) //checking PT as per slab
		void Challan_PT_PTAmount() throws InterruptedException, IOException, AWTException
		{
			test = extent.startTest("PT Challan - Validate 'PT amount' are reflecting correctly");
			
			PT_Methods.Challan_PT_PTAmount(test,"Performer");
